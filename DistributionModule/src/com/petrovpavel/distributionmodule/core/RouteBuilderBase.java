...
import com.petrovpavel.datamodule.exceptions.RouteLengthException;
...
import static com.petrovpavel.datamodule.core.DataManager.*;
import static java.math.BigInteger.ONE;
import static java.math.BigInteger.ZERO;
import static com.petrovpavel.datamodule.utils.MathUtils.inverseFactorial;
...
public class RouteBuilderBase implements RouteBuilder {
    ...
    public Route readTaskResultFiles(BigInteger taskCount, Path folderPath, Consumer<TaskResult> iterator) throws IOException {
    ...
    @Override
    public Path writeJobAndTaskFiles(BigInteger taskSize, String jobName, Path jarFilePath, Path dataFilePath, Path tasksFolderPath,
                                     Path jobFolderPath, String remoteCommand) throws IOException {
        ...
        taskIterator(new TaskIterator() {
            @Override
            public void onNextTask(RouteTask routeTask) throws IOException {
